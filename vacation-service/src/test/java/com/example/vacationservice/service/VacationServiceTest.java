...
class VacationServiceTest {
    ...
    void testCreateRequest_NotEnoughVacationDays() {
        ...
        ResponseStatusException exception = assertThrows(ResponseStatusException.class, () -> vacationService.createRequest(username, requestDto));
        assertThat(exception.getReason()).isEqualTo("Not enough vacation days remaining");
